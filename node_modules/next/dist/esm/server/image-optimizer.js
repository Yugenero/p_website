...
export async function optimizeImage({ buffer, contentType, quality, width, height, nextConfigOutput }) {
    ...
    // End sharp transformation logic
        ...
        if (showSharpMissingWarning && nextConfigOutput === "standalone") {
            Log.error(`Error: 'sharp' is required to be installed in standalone mode for the image optimization to function correctly. Read more at: https://nextjs.org/docs/messages/sharp-missing-in-production`);
...
export async function imageOptimizer(imageUpstream, paramsResult, nextConfig, isDev) {
